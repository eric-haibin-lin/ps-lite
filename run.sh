if [ $1 == "local8" ]; then
    ...
    DMLC_NUM_WORKER=4 NUM_KEY_PER_SERVER=1 NODE_ONE_IP=10.212.179.138 NODE_TWO_IP=10.212.179.130 taskset -c 32-63  bash test_np4.sh scheduler &
    DMLC_NUM_WORKER=4 NUM_KEY_PER_SERVER=1 NODE_ONE_IP=10.212.179.138 NODE_TWO_IP=10.212.179.130 taskset -c 96-127 bash test_np4.sh local &
elif [ $1 == "remote4" ]; then
    DMLC_NUM_WORKER=4 NUM_KEY_PER_SERVER=1 NODE_ONE_IP=10.212.179.138 NODE_TWO_IP=10.212.179.130 taskset -c 32-63  bash test_np4.sh remote &
    DMLC_NUM_WORKER=4 NUM_KEY_PER_SERVER=1 NODE_ONE_IP=10.212.179.138 NODE_TWO_IP=10.212.179.130 taskset -c 96-127 bash test_np4.sh remote &
fi
